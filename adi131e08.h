...
.if $defined(ADI_START)
.emsg ADI_START pin undefined.
.endif

.if $defined(ADI_RESET)
...
ADI_WRITE_REG   .macro  reg_addr, data
                    LDI32   r28, WREG + reg_addr + data
                    SPI_TX  r28.b2
                    SPI_TX  r28.b1
                    SPI_TX  r28.b0
                .endm

ADI_READ_REG    .macro  reg_addr, reg_data
                    LDI32   r28, RREG + reg_addr
                    SPI_TX  r28.b1
                    SPI_TX  r28.b0
                    SPI_RX  reg_data
                .endm

ADI_GET_DATA16  .macro  reg1 = r1, reg2 = r2, reg3 = r3, reg4 = r4, reg5 = r5
                    ; Reset STAT register
                    LDI32   reg1, 0
...
ADI_READ_ALL    .macro  id_reg = r1.b3, config1_reg = r1.b2, config2_reg = r1.b1, config3_reg = r1.b0, fault_reg  = r2.b3, ch1set_reg = r2.b2, ch2set_reg = r2.b1, ch3set_reg = r2.b0, ch4set_reg = r3.b3, ch5set_reg = r3.b2, ch6set_reg = r3.b1, ch7set_reg = r3.b0, ch8set_reg = r4.b3, fault_statp_reg = r4.b2, fault_statn_reg = r4.b1, gpio_reg = r4.b0
                    CLR     SPI_CS          ; Enable SPI (CS = 0)
